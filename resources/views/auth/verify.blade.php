...
mb-2">Forgot Your Password?</h1>

                                    <p class="mb-4">We get it,

                                        stuff happens. Just enter your email address below
...
is-invalid @enderror" id="email" aria-describedby="emailHelp" placeholder="Enter
